...
//
// Arguments    : b_alexnet *obj
//                const real_T inputdata[154587]
//                real32_T outT[1000]
// Return Type  : void
//
...
void b_alexnet::setup()
{
  ...
  this->layers[0]->loadAvg(
    ".\\sumpurn\\codegen\\embed\\lib\\normal\\alexnet_predict\\cnn_alexnet_avg");
  this->layers[1]->createConvLayer(this->layers[0], 11, 11, 3, 96, 4, 4, 0, 0, 1);
  this->layers[1]->loadWeights(
    ".\\sumpurn\\codegen\\embed\\lib\\normal\\alexnet_predict\\cnn_alexnet_conv1_w");
  this->layers[1]->loadBias(
    ".\\sumpurn\\codegen\\embed\\lib\\normal\\alexnet_predict\\cnn_alexnet_conv1_b");
  ...
  this->layers[5]->loadWeights(
    ".\\sumpurn\\codegen\\embed\\lib\\normal\\alexnet_predict\\cnn_alexnet_conv2_w");
  this->layers[5]->loadBias(
    ".\\sumpurn\\codegen\\embed\\lib\\normal\\alexnet_predict\\cnn_alexnet_conv2_b");
  ...
  this->layers[9]->loadWeights(
    ".\\sumpurn\\codegen\\embed\\lib\\normal\\alexnet_predict\\cnn_alexnet_conv3_w");
  this->layers[9]->loadBias(
    ".\\sumpurn\\codegen\\embed\\lib\\normal\\alexnet_predict\\cnn_alexnet_conv3_b");
  ...
  this->layers[11]->loadWeights(
    ".\\sumpurn\\codegen\\embed\\lib\\normal\\alexnet_predict\\cnn_alexnet_conv4_w");
  this->layers[11]->loadBias(
    ".\\sumpurn\\codegen\\embed\\lib\\normal\\alexnet_predict\\cnn_alexnet_conv4_b");
  ...
  this->layers[13]->loadWeights(
    ".\\sumpurn\\codegen\\embed\\lib\\normal\\alexnet_predict\\cnn_alexnet_conv5_w");
  this->layers[13]->loadBias(
    ".\\sumpurn\\codegen\\embed\\lib\\normal\\alexnet_predict\\cnn_alexnet_conv5_b");
  ...
  this->layers[16]->loadWeights(
    ".\\sumpurn\\codegen\\embed\\lib\\normal\\alexnet_predict\\cnn_alexnet_fc6_w");
  this->layers[16]->loadBias(
    ".\\sumpurn\\codegen\\embed\\lib\\normal\\alexnet_predict\\cnn_alexnet_fc6_b");
  ...
  this->layers[19]->loadWeights(
    ".\\sumpurn\\codegen\\embed\\lib\\normal\\alexnet_predict\\cnn_alexnet_fc7_w");
  this->layers[19]->loadBias(
    ".\\sumpurn\\codegen\\embed\\lib\\normal\\alexnet_predict\\cnn_alexnet_fc7_b");
  ...
  this->layers[22]->loadWeights(
    ".\\sumpurn\\codegen\\embed\\lib\\normal\\alexnet_predict\\cnn_alexnet_fc8_w");
  this->layers[22]->loadBias(
    ".\\sumpurn\\codegen\\embed\\lib\\normal\\alexnet_predict\\cnn_alexnet_fc8_b");
