###########################################################################
## Makefile generated for MATLAB file/project 'alexnet_predict'. 
## 
## Makefile     : alexnet_predict_rtw.mk
## Generated on : Tue Jan 23 09:38:29 2018
## MATLAB Coder version: 3.4 (R2017b)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)\alexnet_predict.lib
...
MASTER_ANCHOR_DIR         = 
START_DIR                 = C:\Sumpurn\Projects\GPU\gpucoderdemo_alexnet_live
ARCH                      = win64
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)\alexnet_predict.lib
...
INCLUDES_BUILDINFO = $(START_DIR)\sumpurn\codegen\embed\lib\normal\alexnet_predict;$(START_DIR);$(MATLAB_ROOT)\extern\include;$(MATLAB_ROOT)\simulink\include;$(MATLAB_ROOT)\rtw\c\src;$(MATLAB_ROOT)\rtw\c\src\ext_mode\common;$(MATLAB_ROOT)\rtw\c\ert;C:\Users\KRISHN~1\DOWNLO~1\CUDNN-~1.1\cuda\include
...
DEFINES_STANDARD = -D MODEL=alexnet_predict -D HAVESTDIO -D USE_RTMODEL
...
SRCS = $(START_DIR)\sumpurn\codegen\embed\lib\normal\alexnet_predict\alexnet_predict_initialize.cu $(START_DIR)\sumpurn\codegen\embed\lib\normal\alexnet_predict\alexnet_predict_terminate.cu $(START_DIR)\sumpurn\codegen\embed\lib\normal\alexnet_predict\alexnet_predict.cu $(START_DIR)\sumpurn\codegen\embed\lib\normal\alexnet_predict\DeepLearningNetwork.cu $(START_DIR)\sumpurn\codegen\embed\lib\normal\alexnet_predict\rt_nonfinite.cu $(START_DIR)\sumpurn\codegen\embed\lib\normal\alexnet_predict\rtGetNaN.cu $(START_DIR)\sumpurn\codegen\embed\lib\normal\alexnet_predict\rtGetInf.cu $(START_DIR)\sumpurn\codegen\embed\lib\normal\alexnet_predict\cnn_api.cu
...
OBJS = alexnet_predict_initialize.obj alexnet_predict_terminate.obj alexnet_predict.obj DeepLearningNetwork.obj rt_nonfinite.obj rtGetNaN.obj rtGetInf.obj cnn_api.obj
...
{$(START_DIR)\sumpurn\codegen\embed\lib\normal\alexnet_predict}.cu.obj :
	$(CC) $(CFLAGS) -o  "$@" "$<"


{$(START_DIR)\sumpurn\codegen\embed\lib\normal\alexnet_predict}.c.obj :
	$(CC) $(CFLAGS) -o  "$@" "$<"
